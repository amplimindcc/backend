...
class GlobalExceptionHandler {
    ...
    fun handleSubmissionException(ex: SubmissionException): ResponseEntity<String> {
        return ResponseEntity("Error whilst submitting: ${ex.message}", HttpStatus.INTERNAL_SERVER_ERROR)
    }

    @ExceptionHandler(GitHubApiCallException::class)
    fun handleGitHubApiCallException(ex: GitHubApiCallException): ResponseEntity<String> {
        return ResponseEntity("Error whilst calling GitHub api: ${ex.message}", HttpStatus.SERVICE_UNAVAILABLE)
    }
